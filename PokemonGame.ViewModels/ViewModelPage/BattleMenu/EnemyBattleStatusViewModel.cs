...
namespace PokemonGame.ViewModels.ViewModelPage.BattleMenu
{
    public class EnemyBattleStatusViewModel : ViewModelBase
    {
        ...
        {
            get => _currentHp;
            set { if (SetProperty(ref _currentHp, value)) { OnPropertyChanged(nameof(HpPercentage)); OnPropertyChanged(nameof(HPColor)); } }
        }

        public int MaxHP
        {
            get => _maxHp;
            set { if (SetProperty(ref _maxHp, value)) { OnPropertyChanged(nameof(HpPercentage)); OnPropertyChanged(nameof(HPColor)); } }
        }
