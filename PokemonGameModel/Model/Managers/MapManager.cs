...
public class MapManager
{
    ...
    // ── NPC interaction events (consumed by game controller/presenter) ──
    public event Action<NpcObjectDomain>? TrainerSpotted;   // trainer sees player → auto battle
    public event Action<NpcObjectDomain>? NpcInteracted;    // player presses A on NPC
    ...
    // ---------------------------------------------------------------
    // Player interact (call this on A press)
    // ---------------------------------------------------------------
    ...
    // ---------------------------------------------------------------
    // Called by game controller when dialogue ends
    // ---------------------------------------------------------------
    ...
    private WrapDomain TryGetWarp(int squareRow, int squareCol)
        => ActiveMap.Wraps.FirstOrDefault(w =>
            w.WrapLoc.x == squareRow && w.WrapLoc.y == squareCol);
    ...
    {
        int newSquareRow = squareRow, newSquareCol = squareCol;
